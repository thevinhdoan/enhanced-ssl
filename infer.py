...
def _ensure_data_available(data_dir, dataset, data_zip=None):
    ...
    raise FileNotFoundError(
        f"VTAB test list not found at {expected}. Provide --data_zip or set --data_dir."
    )
...
def main():
    ...
    parser.add_argument("--data_dir", default=None, help="Override data root (default from config).")
    parser.add_argument("--data_zip", default=None, help="Path to a zip containing the data/ folder.")
