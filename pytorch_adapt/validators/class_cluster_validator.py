...
def get_clustering_performance(
    ...
    print(f'feats: {feats}')
    print(f'clabels: {clabels}')
    print(f'centroid_init: {centroid_init}')
    # print(f'labels distribution: {label_to_distribution(labels)}')
    # print(f'clabels distribution: {label_to_distribution(clabels)}')
